...
- **A1**: 90-120小时 → 180-240节课 → A2: 180-200小时 → 360-400节课
- **B1**: 350-400小时 → 700-800节课 → B2: 500-600小时 → 1000-1200节课
- **C1**: 700-800小时 → 1400-1600节课 → C2: 1000-1200小时 → 2000-2400节课
...
2. **换算课程数量**: ${Math.round((daily_minutes * days_per_week * weeks) / 60)}小时 × 2 = ${Math.round((daily_minutes * days_per_week * weeks) / 30)}节25分钟外教课
3. **起点水平推算**: 学员自评${intake.self_assessed_level} ≈ ${intake.self_assessed_level === 'B2' ? '500-600小时(1000-1200节课)' : intake.self_assessed_level === 'B1' ? '350-400小时(700-800节课)' : intake.self_assessed_level === 'A2' ? '180-200小时(360-400节课)' : intake.self_assessed_level === 'A1' ? '90-120小时(180-240节课)' : '基础水平'}
4. **目标水平推算**: "${goal_free_text}" ≈ ${goal_free_text.includes('母语') ? 'C1-C2 (700-1200小时, 1400-2400节课)' : goal_free_text.includes('职场') ? 'B2-C1 (500-800小时, 1000-1600节课)' : goal_free_text.includes('学术') ? 'B2-C1 (500-800小时, 1000-1600节课)' : 'B1-B2 (350-600小时, 700-1200节课)'}

#### 实际递进预期
- **180节课 = 90小时总学习时间 (25分钟/节 × 2节/小时)**
- **起点B2(500-600小时, 1000-1200节课) + 90小时(180节课) = B2+水平 (≈590-690小时, 1180-1380节课)**
- **最终目标C1-C2**: 需要达到700-1200小时 (1400-2400节课)
- **合理递进**: B2→B2+ (当前水平保持和微幅提升)

#### 🚨 关键要求
- **绝不倒退**: B2起点学员绝不能出现A2内容！
- **时长匹配**: 180节课(90小时)的学习应该达到B2+水平，不是C1
- **现实预期**: 90小时不足以达到C1水平，需要更多学习时间
