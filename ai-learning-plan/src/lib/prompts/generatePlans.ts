  ...
  "plans": [
    {
      ...
      "monthly_milestones_one_line": ["第1月里程碑描述", "第2月里程碑描述", "第3月里程碑描述", "第4月里程碑描述"]
    }
  ]
}
\`\`\`
...
## 重要提醒
⚠️ **必须确保monthly_milestones_one_line数组包含正好4个元素**，分别对应第1、2、3、4月的学习里程碑
...
5. **必须生成4个月里程碑**：不要省略任何月份

请基于以上信息生成三档个性化的学习方案，确保每个方案都有完整的4个月里程碑。
